...
const ProfileStrengthCard = ({ strength = {}, onOpenEditModal }) => {
  const { score = 0, completed = [], missing = [] } = strength;
  ...
  return (
    <div className="card shadow-sm border-0 bg-white p-4 mb-4">
      <div className="d-flex flex-wrap align-items-center justify-content-between gap-2 mb-3">
        <div>
          <h3 className="h6 fw-bold text-dark text-uppercase mb-1">DevBoard Profile Strength</h3>
          <p className="text-muted small mb-0">Transparent score based on profile completeness</p>
        </div>
        <div className="d-flex align-items-center gap-2">
          ...
          >
            Improve Profile <FiArrowUpRight />
          </button>
        </div>
      </div>
      ...
      <div className="row g-3">
        ...
        <div className="col-12 col-md-6">
          <div className="p-3 bg-light rounded border h-100">
            ...
            {missing.length === 0 ? (
              <p className="small text-success mb-0">All profile sections are complete!</p>
            ) : (
              <ul className="list-unstyled mb-0 small text-secondary">
